...
// generate the same numbers as in the original C test program
  ...
  std::string map_topic,clicked_point,detected_points,shapes,base_frame_topic;
  
  ros::param::param<float>("~eta", eta, 0.5);
  ros::param::param<std::string>("~map_topic", map_topic, "/jetauto_1/map");
  ros::param::param<std::string>("~robot_frame", base_frame_topic, "/jetauto_1/base_link");
  ros::param::param<std::string>("~clicked_point", clicked_point, "/clicked_point");
  ros::param::param<std::string>("~detected_points", detected_points, "/detected_points");
  ros::param::param<std::string>("~shapes", shapes, "shapes");
  //---------------------------------------------------------------
